...
export default function SubsidyPending() {
  ...
  const { data, isLoading, isFetching, isError } = useGetProjectsQuery({ currentStage: "SUBSIDY", status: "IN_PROGRESS", page });
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-dark-border flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-1.5 min-w-20 justify-center">
                  {isFetching && <span className="w-3.5 h-3.5 border-2 border-gray-200 dark:border-gray-700 border-t-brand-blue rounded-full animate-spin inline-block" />}
